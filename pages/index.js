...
class App extends React.Component {
  ...
  getPi = () => {
    ...
    xhr.open("GET", "https://piaas.now.sh/api/p?n=9");
    xhr.send(data);
  };
  componentDidMount() {
    this.getPi();
          ...
          >
            ...
            >
              ...
              <Button
                ...
                hoverIndicator
                primary
                href="https://github.com/ntaheij/PI-as-a-Service"
              />
            </Box>
            <Box
              direction="row-responsive"
...
I don't know.
[You want a *billion* digits of π ?](https://piaas.now.sh/api/p?n=1000000000)
Too many? [How about 1 *million* ?](https://piaas.now.sh/api/p?n=1000000)
`;
const example = `
### Check this out!
Its really easy to get started. No fancy-shmacy API keys or authentication.
Just send a \`GET\` request to \`piaas.now.sh/api/p\`
**Take a look:**
`;
const request = `
#### Request:
...
[PIaaS.now.sh](https://piaas.now.sh)
`;
export default App;
